...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/views/game/game.module.ts")).then(function (m) {
          return m.GameModule;
        });
      }
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _views_game_game_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./views/game/game.module */
    "./src/app/views/game/game.module.ts");
    /* harmony import */


    var _views_home_home_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./views/home/home.module */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _material_module__WEBPACK_IMPORTED_MODULE_6__["MaterialModule"], _views_home_home_module__WEBPACK_IMPORTED_MODULE_8__["HomeModule"], _views_game_game_module__WEBPACK_IMPORTED_MODULE_7__["GameModule"]]]
    });
  ...
  function srcAppMaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵsetClassMetadata"](MaterialModule, [{
  ...
  function srcAppServicesAudioServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../shared/enums/audio.enum */
    "./src/app/shared/enums/audio.enum.ts");

    var AUDIO_DIR_PATH = 'assets/audio';

    var AUDIO_SRC = _defineProperty(_defineProperty(_defineProperty({}, _shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_1__["AudioEnum"].CORRECT, 'correct.mp3'), _shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_1__["AudioEnum"].TURN_CARD, 'page-turn.mp3'), _shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_1__["AudioEnum"].WIN, 'tada.mp3');
      ...
      _createClass(AudioService, [{
        ...
        value: function load() {
          ...
          Object.entries(AUDIO_SRC).forEach(function (_ref) {
            ...
            _this._audioMap[key] = _this._load(src);
          });
        ...
        value: function _load(src) {
          var audio = new Audio("".concat(AUDIO_DIR_PATH, "/").concat(src));
          audio.load();
          return audio;
        }
      }, {
        key: "play",
        value: function play(audioKey) {
  ...
  function srcAppServicesDialogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_components_dialog_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var DialogService = /*#__PURE__*/function () {
      ...
      _createClass(DialogService, [{
        ...
        value: function openConfirmationDialog(data) {
          var dialogRef = this.dialog.open(_shared_components_dialog_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_1__["ConfirmationDialogComponent"], {
  ...
  function srcAppServicesGameServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_model_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../shared/model/card */
    "./src/app/shared/model/card.ts");
    /* harmony import */


    var _shared_util_array_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../shared/util/array.util */
    "./src/app/shared/util/array.util.ts");
    /* harmony import */


    var _shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../shared/enums/card-position-id-type.enum */
    ...
    var _audio_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./audio.service */
    "./src/app/services/audio.service.ts");

    var IMG_FILENAME_SEP = '_';

    var GameService = /*#__PURE__*/function () {
      function GameService(library, router, audioService) {
      ...
      _createClass(GameService, [{
        ...
        value: function _getCardsForSameImagePerPair() {
          var cards = this._gameConfig.cardImages.map(function (img, i) {
            return new _shared_model_card__WEBPACK_IMPORTED_MODULE_6__["Card"]("".concat(i + 1), img);
          });
        ...
        value: function _getCardsForDifferentImagesPerPair() {
          ...
          var cardImages = this._gameConfig.cardImages;

          var keys = this._getFilenamePrefixForDiffImagesPerPair(cardImages);

          var cards = [];
          keys.forEach(function (key) {
            cardImages.filter(function (img) {
              return _this2._getCardImageFilenamePrefix(img) === key;
            }).forEach(function (img) {
              return cards.push(new _shared_model_card__WEBPACK_IMPORTED_MODULE_6__["Card"](key, img));
            });
          });
        ...
        value: function _getFilenamePrefixForDiffImagesPerPair(cardImages) {
          ...
          var filenames = cardImages.map(function (img) {
            return _this3._getCardImageFilenamePrefix(img);
          });

          var occurrences = _shared_util_array_util__WEBPACK_IMPORTED_MODULE_7__["ArrayUtil"].getNumOccurrences(filenames);
        ...
        value: function onChooseCard(choosen) {
          ...
          if (this._selectedCard1.code == this._selectedCard2.code) {
            this._pairCount--;
            setTimeout(function () {
              _this4.audioService.play(_shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_5__["AudioEnum"].CORRECT);
            }, 100);
          } else {
          ...
          setTimeout(function () {
            if (win) {
              _this4.audioService.play(_shared_enums_audio_enum__WEBPACK_IMPORTED_MODULE_5__["AudioEnum"].WIN);
            }
    ...
    GameService.ɵfac = function GameService_Factory(t) {
      return new (t || GameService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_9__["FaIconLibrary"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_audio_service__WEBPACK_IMPORTED_MODULE_11__["AudioService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameService, [{
        ...
        return [{
          ...
          type: _audio_service__WEBPACK_IMPORTED_MODULE_11__["AudioService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppSharedComponentsDialogConfirmationDialogConfirmationDialogDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedComponentsDialogConfirmationDialogConfirmationDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _confirmation_dialog_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    ConfirmationDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ConfirmationDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, " N\xE3o ");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ConfirmationDialogComponent, [{
        ...
        return [{
          type: _confirmation_dialog_data__WEBPACK_IMPORTED_MODULE_2__["ConfirmationDialogData"],
          decorators: [{
  ...
  /***/
  function srcAppSharedComponentsDialogDialogModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    DialogModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_2__["MaterialModule"]]]
    });
  ...
  /***/
  function srcAppSharedComponentsInputAbstractInputComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AbstractInputComponent = /*#__PURE__*/function () {
      ...
      _createClass(AbstractInputComponent, [{
        ...
        key: "_setFormControlAsInvalid",
        value: function _setFormControlAsInvalid(control) {
          control.setErrors({
            'invalid': true
          });
        ...
        key: "_setAsValid",
        value: function _setAsValid() {
          this._setFormControlAsValid(this.formControl);
        }
      }, {
        key: "_setFormControlAsValid",
        value: function _setFormControlAsValid(control) {
          control.setErrors(null);
          control.markAsTouched();
        }
      }, {
        key: "_setAsRequired",
        value: function _setAsRequired() {
          this._setFormControlAsRequired(this.formControl);
        }
      }, {
        key: "_setFormControlAsRequired",
        value: function _setFormControlAsRequired(control) {
          control.setErrors({
            'required': true
          });
          control.markAsTouched();
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AbstractInputComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedComponentsInputInputLabelInputLabelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function InputLabelComponent_span_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    InputLabelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 3,
      consts: [["class", "input-label-comment", 4, "ngIf"], [1, "input-label-required"], [1, "input-label-comment"]],
      ...
      directives: [_angular_material_form_field__WEBPACK_IMPORTED_MODULE_1__["MatLabel"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InputLabelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedComponentsInputInputNumberInputNumberComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function InputNumberComponent_mat_error_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "obrigat\xF3rio");
    ...
    function InputNumberComponent_mat_error_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Valor m\xEDnimo \xE9 ");
    ...
    function InputNumberComponent_mat_error_6_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Valor m\xE1ximo \xE9 ");
    ...
    function InputNumberComponent_mat_error_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "inv\xE1lido");
    ...
    var InputNumberComponent = /*#__PURE__*/function (_abstract_input_compo) {
      _inherits(InputNumberComponent, _abstract_input_compo);
      ...
      function InputNumberComponent() {
        ...
        _this5 = _callSuper(this, InputNumberComponent, arguments);
        _this5.min = null;
        _this5.max = null;
        return _this5;
      }
    ...
    InputNumberComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 10,
      consts: [[3, "id", "ngClass"], [3, "label", "comment", "required", 4, "ngIf"], ["appearance", "outline", "floatLabel", "never", "color", "primary", 1, "w-100", "mat-form-field-label-out"], ["matInput", "", "type", "number", 3, "formControl", "min", "max", "change"], [4, "ngIf"], [3, "label", "comment", "required"], ["aria-hidden", "false"], ["aria-label", "false"]],
      template: function InputNumberComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function InputNumberComponent_Template_input_change_3_listener($event) {
    ...
    var ɵInputNumberComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](InputNumberComponent);
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InputNumberComponent, [{
        ...
        args: [{
          ...
          styleUrls: ['./input-number.component.scss', '../abstract-input.component.scss']
        }]
      }], null, {
        min: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppSharedComponentsInputInputTextInputTextComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function InputTextComponent_mat_error_6_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Tamanho m\xEDnimo: ");
    ...
    var InputTextComponent = /*#__PURE__*/function (_abstract_input_compo2) {
      _inherits(InputTextComponent, _abstract_input_compo2);
      ...
      function InputTextComponent() {
        ...
        _this6 = _callSuper(this, InputTextComponent, arguments);
        _this6.placeholder = '';
        _this6.maxLength = 100;
        _this6.title = '';
        return _this6;
      }
    ...
    InputTextComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 16,
      consts: [[3, "id", "ngClass"], [3, "label", "comment", "required"], ["appearance", "outline", "floatLabel", "never", "color", "primary", 1, "w-100", "mat-form-field-label-out"], ["matInput", "", "type", "text", 3, "formControl", "id", "name", "minLength", "maxLength", "title", "placeholder", "readonly", "change"], [4, "ngIf"], ["aria-label", "false"]],
      template: function InputTextComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function InputTextComponent_Template_input_change_3_listener($event) {
    ...
    var ɵInputTextComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](InputTextComponent);
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InputTextComponent, [{
        ...
        args: [{
          ...
          styleUrls: ['./input-text.component.scss', '../abstract-input.component.scss']
        }]
      }], null, {
        placeholder: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppSharedComponentsInputInputModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _input_label_input_label_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./input-label/input-label.component */
    "./src/app/shared/components/input/input-label/input-label.component.ts");
    /* harmony import */
    ...
    var _input_number_input_number_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./input-number/input-number.component */
    "./src/app/shared/components/input/input-number/input-number.component.ts");
    /* harmony import */


    var _input_text_input_text_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _upload_image_upload_image_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    InputModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_3__["MaterialModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](InputModule, {
        declarations: [_input_label_input_label_component__WEBPACK_IMPORTED_MODULE_2__["InputLabelComponent"], _input_number_input_number_component__WEBPACK_IMPORTED_MODULE_5__["InputNumberComponent"], _input_text_input_text_component__WEBPACK_IMPORTED_MODULE_6__["InputTextComponent"], _select_select_component__WEBPACK_IMPORTED_MODULE_7__["SelectComponent"], _upload_image_upload_image_component__WEBPACK_IMPORTED_MODULE_8__["UploadImageComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_3__["MaterialModule"]],
        exports: [_input_number_input_number_component__WEBPACK_IMPORTED_MODULE_5__["InputNumberComponent"], _input_text_input_text_component__WEBPACK_IMPORTED_MODULE_6__["InputTextComponent"], _select_select_component__WEBPACK_IMPORTED_MODULE_7__["SelectComponent"], _upload_image_upload_image_component__WEBPACK_IMPORTED_MODULE_8__["UploadImageComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppSharedComponentsInputSelectSelectComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function SelectComponent_mat_option_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SelectComponent_mat_error_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function SelectComponent_div_7_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Erro ao buscar op\xE7\xF5es para ", ctx_r3.label, "\n");
      }
    }

    var SelectComponent = /*#__PURE__*/function (_abstract_input_compo3) {
      _inherits(SelectComponent, _abstract_input_compo3);
    ...
    SelectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 11,
      consts: [[3, "id", "ngClass"], [3, "label", "comment", "required"], ["appearance", "outline", "floatLabel", "never", "color", "primary", 1, "w-100", "mat-form-field-label-out"], [3, "formControl", "multiple", "selectionChange"], [3, "value", 4, "ngIf"], [3, "value", "disabled", 4, "ngFor", "ngForOf"], [4, "ngIf"], ["class", "loading-options-error", 4, "ngIf"], [3, "value"], ["allOption", ""], [3, "value", "disabled"], ["aria-label", "false"], [1, "loading-options-error"]],
  ...
  /***/
  function srcAppSharedComponentsInputUploadImageUploadImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_model_card_image_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/shared/model/card-image.model */
    ...
    function UploadImageComponent_app_input_label_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UploadImageComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function UploadImageComponent_div_2_Template_input_change_1_listener($event) {
    ...
    function UploadImageComponent_ng_template_3_Template(rf, ctx) {
      if (rf & 1) {
        var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 7, 6);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function UploadImageComponent_ng_template_3_Template_input_change_0_listener($event) {
    ...
    var UploadImageComponent = /*#__PURE__*/function (_abstract_input_compo4) {
      _inherits(UploadImageComponent, _abstract_input_compo4);

      function UploadImageComponent(toastService) {
        var _this9;

        _classCallCheck(this, UploadImageComponent);

        _this9 = _callSuper(this, UploadImageComponent);
        _this9.toastService = toastService;
        _this9.ACCEPT_IMG = ['image/png', 'image/jpeg'];
        _this9.multiple = false;
        _this9.selectAllDir = false;
        _this9._numFiles = 0;
        return _this9;
      }
      ...
      _createClass(UploadImageComponent, [{
        ...
        value: function onSelectFiles($event) {
          ...
          var _this$_extractFiles = this._extractFiles((_a = $event === null || $event === void 0 ? void 0 : $event.target) === null || _a === void 0 ? void 0 : _a.files),
              files = _this$_extractFiles.files,
              allOk = _this$_extractFiles.allOk;

          if (!allOk) {
            this._inputElem.nativeElement.value = "";
            var accept = this.ACCEPT_IMG.map(function (x) {
              return x.replace('image/', '');
            }).join(', ');
            this.toastService.error("Pelo menos 1 arquivo selecionado est\xE1 fora dos formatos de imagem aceitos: ".concat(accept, ". Tente novamente!"));
            return;
          }

          files.forEach(function (file) {
            return _this10._readFile(file);
          });
        }
      }, {
        key: "_extractFiles",
        ...
        value: function _readFile(file) {
          ...
          reader.onload = function (fileReaderEvent) {
            _this11._images.push(new src_app_shared_model_card_image_model__WEBPACK_IMPORTED_MODULE_2__["CardImage"](fileReaderEvent.target.result, file.name));

            if (_this11._images.length == _this11._numFiles) {
              _this11.formControl.setValue(_this11._images);
            }
          };
    ...
    UploadImageComponent.ɵfac = function UploadImageComponent_Factory(t) {
      return new (t || UploadImageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_3__["ToastService"]));
    };
    ...
    UploadImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 3,
      consts: [[1, "input-file"], [3, "label", "comment", "required", 4, "ngIf"], [4, "ngIf", "ngIfElse"], ["regularInput", ""], [3, "label", "comment", "required"], ["type", "file", "multiple", "", "webkitdirectory", "", 3, "accept", "change"], ["uploadInput", ""], ["type", "file", 3, "accept", "multiple", "change"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _input_label_input_label_component__WEBPACK_IMPORTED_MODULE_5__["InputLabelComponent"]],
  ...
  /***/
  function srcAppSharedConstantsGlobalValuesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedConstantsIconsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedEnumsAudioEnumTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedEnumsCardPositionIdTypeEnumTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CardPositionIdTypeEnum", function () {
      return CardPositionIdTypeEnum;
    });
  ...
  /***/
  function srcAppSharedModelCardImageModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CardImage", function () {
      return CardImage;
    });

    var CardImage = /*#__PURE__*/_createClass(function CardImage(base64, filename) {
  ...
  /***/
  function srcAppSharedModelCardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Card = /*#__PURE__*/_createClass(function Card(code, img) {
  ...
  /***/
  function srcAppSharedModelGameConfigModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var GameConfig = /*#__PURE__*/function () {
      ...
      _createClass(GameConfig, [{
        key: "numPairs",
        get: function get() {
          var numPairImages = this.cardImages.length;
  ...
  /***/
  function srcAppSharedUtilArrayUtilTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsGameGameModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_components_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/shared/components/dialog/dialog.module */
    "./src/app/shared/components/dialog/dialog.module.ts");
    /* harmony import */
    ...
    var _memory_card_memory_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./memory-card/memory-card.component */
    ...
    GameModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], src_app_shared_components_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_5__["DialogModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](GameModule, {
        declarations: [_game_game_component__WEBPACK_IMPORTED_MODULE_6__["GameComponent"], _memory_card_memory_card_component__WEBPACK_IMPORTED_MODULE_7__["MemoryCardComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_8__["NavbarComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], src_app_shared_components_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_5__["DialogModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppViewsGameGameGameComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_constants_global_values__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/shared/constants/global.values */
    "./src/app/shared/constants/global.values.ts");
    /* harmony import */


    var src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/shared/enums/card-position-id-type.enum */
    "./src/app/shared/enums/card-position-id-type.enum.ts");
    /* harmony import */


    var src_app_services_game_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function GameComponent_div_4_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function GameComponent_div_5_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      if (rf & 2) {
        var r_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().index;
    ...
    function GameComponent_div_5_app_memory_card_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-memory-card", 12);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelect", function GameComponent_div_5_app_memory_card_2_Template_app_memory_card_onSelect_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r10.onChooseCard($event);
        });
    ...
    var GameComponent = /*#__PURE__*/function () {
      function GameComponent(gameService, dialogService, toastService) {
      ...
      _createClass(GameComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var gameConfig = this.gameService.config;
          ...
          if (gameConfig.backgroundImgSrc) {
            this.backgroundStyle = "url(".concat(gameConfig.backgroundImgSrc, ")");
          }
        ...
        key: "_setBoardDim",
        value: function _setBoardDim(numCards) {
          var numCols = numCards % 5 == 0 ? 5 : 4;
          var numRows = numCards / numCols;
          ...
          if (this.gameService.config.cardPositionIdType == src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_2__["CardPositionIdTypeEnum"].ROW_COLUMN) {
            this.grid = {
              rows: _toConsumableArray(Array(numRows).keys()).map(function (r) {
                return String.fromCharCode('A'.charCodeAt(0) + r);
              }),
              columns: _toConsumableArray(Array(numCols).keys()).map(function (c) {
                return c + 1;
              })
            };
          }
        ...
        value: function _startNewGame() {
          ...
          var numCols = this._boardDim.numCols;

          for (var r = 0; r < this._boardDim.numRows; r++) {
            var idx = r * numCols;
        ...
        key: "_printPairs",
        value: function _printPairs() {
          var numCards = this.cardRows.length;
          ...
          var pairs = [];
          var cards = [];
          this.cardRows.forEach(function (rowCards) {
            return cards.push.apply(cards, _toConsumableArray(rowCards));
          });
          cards.forEach(function (card, i) {
            ...
            var j = cards.findIndex(function (c, j) {
              return c.code === card.code && j != i;
            });
            indices.push.apply(indices, [i, j]);
            pairs.push([i + 1, j + 1]);
          });
        ...
        value: function newGame() {
          ...
          this._checkGameFinishedAndDoIt('Tem certeza que deseja iniciar novo jogo?', function () {
            return _this12._startNewGame();
          });
        }
      }, {
        key: "goHome",
        value: function goHome() {
          ...
          this._checkGameFinishedAndDoIt('Tem certeza que deseja sair do jogo?', function () {
            return _this13._goHome();
          });
        }
      }, {
        key: "_checkGameFinishedAndDoIt",
        value: function _checkGameFinishedAndDoIt(confirmQuestion, callback) {
        ...
        key: "_openConfirmationDialog",
        value: function _openConfirmationDialog(confirmQuestion, callback) {
        ...
        key: "onChooseCard",
        value: function onChooseCard($card) {
          var _this14 = this;

          var win = this.gameService.onChooseCard($card);

          if (win) {
            setTimeout(function () {
              _this14._openNewGameDialog();
            }, src_app_shared_constants_global_values__WEBPACK_IMPORTED_MODULE_1__["VALUES"].winNotificationTimeout);
          }
        }
      }, {
        key: "_openNewGameDialog",
        value: function _openNewGameDialog() {
          var _this15 = this;
    ...
    var BoardDim = /*#__PURE__*/_createClass(function BoardDim(numRows, numCols) {
      _classCallCheck(this, BoardDim);
  ...
  /***/
  function srcAppViewsGameMemoryCardMemoryCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MemoryCardComponent", function () {
    ...
    var src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/shared/enums/card-position-id-type.enum */
    "./src/app/shared/enums/card-position-id-type.enum.ts");
    /* harmony import */


    var src_app_services_game_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/game.service */
    "./src/app/services/game.service.ts");
    /* harmony import */
    ...
    function MemoryCardComponent_img_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MemoryCardComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MemoryCardComponent_fa_icon_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var MemoryCardComponent = /*#__PURE__*/function () {
      function MemoryCardComponent(gameService) {
        _classCallCheck(this, MemoryCardComponent);
      ...
      _createClass(MemoryCardComponent, [{
        key: "isRotated",
        get: function get() {
        ...
        value: function ngOnInit() {
          ...
          this.gameService.getCoveredCards().subscribe(function (coveredCards) {
            return coveredCards.map(function (card) {
              return _this16._isRotated = card.id == _this16.card.id ? false : _this16._isRotated;
            });
          });
        }
      }, {
    ...
    MemoryCardComponent.ɵfac = function MemoryCardComponent_Factory(t) {
      return new (t || MemoryCardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"]));
    };

    MemoryCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MemoryCardComponent,
      selectors: [["app-memory-card"]],
      inputs: {
        card: "card"
      },
      outputs: {
      ...
      decls: 8,
      vars: 7,
      consts: [[1, "card", 3, "ngClass", "click"], [1, "card-inner"], [1, "front"], ["alt", "card", 3, "src", 4, "ngIf"], [1, "back", "bg-primary-2"], [3, "ngSwitch"], ["class", "card-id-number quicksand", 4, "ngSwitchCase"], ["size", "3x", 3, "icon", 4, "ngSwitchCase"], ["alt", "card", 3, "src"], [1, "card-id-number", "quicksand"], ["size", "3x", 3, "icon"]],
      template: function MemoryCardComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MemoryCardComponent_Template_div_click_0_listener() {
            return ctx.onClick();
          });
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgSwitch"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgSwitchCase"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FaIconComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MemoryCardComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppViewsGameNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var NavbarComponent = /*#__PURE__*/_createClass(function NavbarComponent() {
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 1,
      consts: [["color", "primary"], ["mat-icon-button", "", "aria-label", "Home", "matTooltip", "Home", 3, "click"], [1, "title"], ["mat-icon-button", "", "aria-label", "New Game", "matTooltip", "New Game", 3, "click"]],
  ...
  /***/
  function srcAppViewsHomeGameConfigFormGameConfigFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameConfigFormComponent", function () {
      return GameConfigFormComponent;
    });
    /* harmony import */
    ...
    var src_app_shared_model_game_config_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var _shared_components_input_input_text_input_text_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../../shared/components/input/input-text/input-text.component */
    "./src/app/shared/components/input/input-text/input-text.component.ts");
    /* harmony import */


    var _shared_components_input_upload_image_upload_image_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../../shared/components/input/upload-image/upload-image.component */
    "./src/app/shared/components/input/upload-image/upload-image.component.ts");
    /* harmony import */


    var _shared_components_input_select_select_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../../../shared/components/input/select/select.component */
    "./src/app/shared/components/input/select/select.component.ts");

    function GameConfigFormComponent_div_10_form_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function GameConfigFormComponent_div_10_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GameConfigFormComponent_div_10_Template_button_click_3_listener() {
    ...
    function GameConfigFormComponent_div_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function GameConfigFormComponent_div_11_Template_input_change_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

          var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r6.onSelectConfigFile($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GameConfigFormComponent_div_11_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);
    ...
    var GameConfigFormComponent = /*#__PURE__*/function () {
      function GameConfigFormComponent(fb, gameService, toastService) {
        _classCallCheck(this, GameConfigFormComponent);
      ...
      _createClass(GameConfigFormComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.onChangeInputType();
        }
      }, {
        key: "onChangeInputType",
        value: function onChangeInputType() {
        ...
        value: function _setOptions() {
          this.cardPositionOptions = [{
            id: src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_2__["CardPositionIdTypeEnum"].NUMBERS,
            label: 'Números'
          }, {
            id: src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_2__["CardPositionIdTypeEnum"].IMAGES,
            label: 'Imagens'
          }, {
            id: src_app_shared_enums_card_position_id_type_enum__WEBPACK_IMPORTED_MODULE_2__["CardPositionIdTypeEnum"].ROW_COLUMN,
            label: 'Linhas e colunas (Batalha Naval)'
          }];
          this.numImagesPerPairOptions = [{
            id: true,
            label: 'Sim'
        ...
        key: "onSelectConfigFile",
        value: function onSelectConfigFile($event) {
          var _a;

          var file = (_a = $event === null || $event === void 0 ? void 0 : $event.target) === null || _a === void 0 ? void 0 : _a.files[0]; // TODO
    ...
    GameConfigFormComponent.ɵfac = function GameConfigFormComponent_Factory(t) {
      return new (t || GameConfigFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_game_service__WEBPACK_IMPORTED_MODULE_4__["GameService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_5__["ToastService"]));
    };

    GameConfigFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: GameConfigFormComponent,
      selectors: [["app-game-config-form"]],
      decls: 12,
      vars: 6,
      consts: [[1, "form-line", "mt-2", "ms-4"], ["aria-label", "label", 3, "ngModel", "ngModelChange", "change"], ["color", "primary", 3, "value"], [1, "mt-4", 3, "ngSwitch"], [4, "ngSwitchCase"], [3, "formGroup", 4, "ngIf"], ["mat-raised-button", "", "type", "submit", "color", "primary", 3, "click"], [3, "formGroup"], [1, "form-line"], ["label", "T\xEDtulo", "controlName", "title", 3, "form"], ["label", "Imagem de fundo", "controlName", "backgroundImgSrc", 3, "form"], ["label", "Cada par possui imagens iguais?", "controlName", "singleImgPerPair", 3, "form", "options"], ["label", "Pasta contendo as imagens das cartas", "controlName", "cardImages", 3, "form", "selectAllDir"], ["label", "Tipo de identifica\xE7\xE3o das posi\xE7\xF5es das cartas", "controlName", "cardPositionIdType", 3, "form", "options"], ["type", "file", "hidden", "", "accept", "txt", 3, "change"], ["inputFile", ""], ["mat-raised-button", "", "color", "primary", 3, "click"]],
      template: function GameConfigFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-label");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Selecione como deseja inserir as informa\xE7\xF5es para o jogo:");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function GameConfigFormComponent_Template_mat_radio_group_ngModelChange_4_listener($event) {
            return ctx.inputType = $event;
          })("change", function GameConfigFormComponent_Template_mat_radio_group_change_4_listener() {
            return ctx.onChangeInputType();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Inserir arquivo de configura\xE7\xE3o");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameConfigFormComponent, [{
        ...
        return [{
          ...
          type: src_app_services_game_service__WEBPACK_IMPORTED_MODULE_4__["GameService"]
        }, {
          type: src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_5__["ToastService"]
        }];
      }, null);
  ...
  function srcAppViewsHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _game_config_form_game_config_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./game-config-form/game-config-form.component */
    "./src/app/views/home/game-config-form/game-config-form.component.ts");
    /* harmony import */
    ...
    HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), src_app_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], src_app_shared_components_input_input_module__WEBPACK_IMPORTED_MODULE_5__["InputModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](HomeModule, {
        declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"], _game_config_form_game_config_form_component__WEBPACK_IMPORTED_MODULE_6__["GameConfigFormComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], src_app_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], src_app_shared_components_input_input_module__WEBPACK_IMPORTED_MODULE_5__["InputModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppViewsHomeHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _game_config_form_game_config_form_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../game-config-form/game-config-form.component */
    "./src/app/views/home/game-config-form/game-config-form.component.ts");
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 0,
      consts: [["color", "primary"], [1, "title"], [1, "content"]],
      ...
      directives: [_angular_material_toolbar__WEBPACK_IMPORTED_MODULE_1__["MatToolbar"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_1__["MatToolbarRow"], _game_config_form_game_config_form_component__WEBPACK_IMPORTED_MODULE_2__["GameConfigFormComponent"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\GitHub\memory-game\memory-game-angular\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
